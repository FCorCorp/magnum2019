 ...
 */
public class VAgregarCaracteristica extends javax.swing.JFrame {

    /**
     * Creates new form VAgregarCaracteristica
     */
    public VAgregarCaracteristica() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAgregarCaracteristica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAgregarCaracteristica().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField campoSimbolo;
